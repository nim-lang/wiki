...
[Nim](http://nim-lang.org) es un lenguaje de programación imperativo de tipado estático,
...
rendimiento, y características de ejecución de código en tiempo de compilación.

- [Tutorial en Espanol](https://github.com/nim-lang/Nim/wiki/Nim-Tutorial-1-(Spanish))
- [Continuar leyendo Nim para desarrolladores Python.](https://github.com/nim-lang/Nim/wiki/Nim-for-Python-Programmers-ES#tabla-de-contenidos)
- [Continuar leyendo Nim para desarrolladores JavaScript (en Ingles).](https://github.com/nim-lang/Nim/wiki/Nim-for-TypeScript-Programmers#table-of-contents)
- [Usar Nim desde el navegador en el Nim Playground.](https://play.nim-lang.org)
"""
